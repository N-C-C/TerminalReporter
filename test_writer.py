...
def test_column_generator():
    layout = writer.column_generator([3, 3, 3])
    assert layout == "{: <3}{: <3}{: <3}\n"


def test_title_generator():
    title = writer.title_generator("hello world", 15)
    expected_title = ""
    expected_title += "==========================\n"
...
def test_generate_report():
    data = [["hello", "world"],
            ["goodbye", "world"]]
    actual_report = writer.generate_report(writer.title_generator("hello world", 20),
...
def test_display_report():
    ...
    test_file = "foo.txt"
    actual_text = ""
    writer.display_report(expected_text, test_file)
